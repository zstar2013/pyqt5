...
class QMessageBoxDemo(QWidget):
    ...
    def showDialog(self):
        ...
        if text=='显示关于对话框':
            ...
            QMessageBox.warning(self,'警告','这是一个警告对话框',QMessageBox.No|QMessageBox.No,QMessageBox.Yes)
        elif text=='显示错误对话框':
            QMessageBox.critical(self,'警告','这是一个错误对话框',QMessageBox.No|QMessageBox.No,QMessageBox.Yes)
        elif text=='显示提问对话框':
            QMessageBox.question(self,'警告','这是一个提问对话框',QMessageBox.No|QMessageBox.No,QMessageBox.Yes)
